...
class FDMSolver():
    ...
    def plot_Animation(self, x: Iterable[float] | None = None, 
        ...
        line2, = ax.plot(x, np.abs(self.analytic_solution(self.x, self.t[0]))**2, label="Analytic t = 0 s", c=color2, ls="--")
        ...
        ani = FuncAnimation(fig, update, frames=range(self.M), blit=False, interval=1000/fps)
